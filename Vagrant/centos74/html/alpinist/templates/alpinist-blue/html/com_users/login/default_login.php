...
$itemid = BscoreHelper::BsgetItemId('login',null,'com_users');
?>
<div class="login<?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login&Itemid='.$itemid); ?>" method="post">
