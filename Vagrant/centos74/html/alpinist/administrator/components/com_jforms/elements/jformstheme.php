 ...
 * @subpackage JForms.Elements
 */
class JFormsElementjformstheme extends JFormsElement
{
	/**
	* Element name
	*
	...
	*/
	...
	{
		$themeFiles = JFolder::files(JFORMS_FRONTEND_PATH.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR.'form'.DIRECTORY_SEPARATOR.'tmpl','^(.+)_thank.php$');
