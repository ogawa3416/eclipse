<?php
/**
* Non-Translatable Paramteres Table class
*
* @version		$Id: parameters.php 396 2010-08-06 15:15:11Z dr_drsh $
* @package		Joomla
...
class TableParameters extends JTable
{
	...
	function TableParameters(&$db) {
		parent::__construct('#__jforms_parameters', 'id', $db);
	}
	...
	function _getInsertedValues($updateNull=true){
		...
		if(!isset($this->_delayedInsertSQLFormat))
			$this->_delayedInsertSQLFormat = sprintf('INSERT INTO '.$this->_db->quoteName($this->_tbl).' ( %s ) VALUES ',implode(',', $fields));
