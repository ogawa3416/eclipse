...
define('JFORMS_FS_PATH'      , JPATH_ROOT.DIRECTORY_SEPARATOR.'media'.DIRECTORY_SEPARATOR.'com_jforms'.DIRECTORY_SEPARATOR.'files'.DIRECTORY_SEPARATOR);
...
function JFormsInitializePluginManager(){require_once (JFORMS_BACKEND_PATH.DIRECTORY_SEPARATOR.'libraries'.DIRECTORY_SEPARATOR.'pluginmanager'.DIRECTORY_SEPARATOR.'manager.php');$GLOBALS['JFormGlobals'] = array();$GLOBALS['JFormGlobals']['JFormsPlugin'] = new JFormsPluginController();}
