...
*
* @version		$Id: frontend.php BsAlpinist2.5.0 $
* @package		Joomla
...
class JFormsFrontend{
	...
	static function javascript_validateForm( $form ){
	...
	static function javascript_clearErrors( $form ){
