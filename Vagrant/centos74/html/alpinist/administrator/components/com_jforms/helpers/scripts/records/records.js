...
function exportRecords( form ){
	...
	if(exportRangeElement && exportRangeElement.value == 'selected' && selectedIds == null ){
		alert("<?php echo JText::_('PLEASE_SELECT_THE_RECORDS_YOU_WOULD_LIKE_TO_EXPORT')?>");
		return;
	}
...
function deleteRecords( rowIds ){
	...
	var cfm = confirm("<?php echo JText::_('ARE_YOU_SURE_YOU_WANT_TO_DELETE_THIS_THESE_RECORDS'); ?>");
	if( !cfm )return;
