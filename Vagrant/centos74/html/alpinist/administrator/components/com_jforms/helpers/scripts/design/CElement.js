/**
 * CElement
 * @version		$Id: CElement.js 396 2010-08-06 15:15:11Z dr_drsh $
* @package		Joomla
* @subpackage	JForms
...
var CElement = new Class({
	...
	initialize: function( parent, id, beforeObject, options ) {
		...
		if( window.navigator.userAgent.toLowerCase().indexOf("msie") != -1 ){this.pixelCorrection = 0;}
