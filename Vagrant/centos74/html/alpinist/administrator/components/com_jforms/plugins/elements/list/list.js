...
*
* @version		$Id: list.js BsAlpinist 2.5.0 $
* @package		Joomla
* @subpackage	JForms
...
$dir = JFORMS_BACKEND_PATH.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'elements'.DIRECTORY_SEPARATOR.'list'.DIRECTORY_SEPARATOR.'common_lists'.DIRECTORY_SEPARATOR;
$lists = array();
if ($dh = opendir($dir)) {
...
var list = new Class({
	...
	vaildate : function(){
		...
		if( e.length < 2 ){
			errors.push( "<?php echo JText::_('YOU_MUST_HAVE_AT_LEAST_TWO_ELEMENTS'); ?>" );
		}
		return errors;
	},
