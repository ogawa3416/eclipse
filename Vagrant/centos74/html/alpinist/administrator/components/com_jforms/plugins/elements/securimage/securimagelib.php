...
class Securimage {
  ...
  function Securimage()
  {
	...
	$this->audio_path	= dirname(__FILE__).'/'.$this->audio_path; 
	$this->ttf_file		= dirname(__FILE__).'/'.$this->ttf_file;
	$this->wordlist_file= dirname(__FILE__).'/'.$this->wordlist_file;
	$this->gd_font_file = dirname(__FILE__).'/'.$this->gd_font_file;
...
//	define( 'DS', DIRECTORY_SEPARATOR );
	...
	$session->set('securimage_code_value',strtolower($this->code));
  }
