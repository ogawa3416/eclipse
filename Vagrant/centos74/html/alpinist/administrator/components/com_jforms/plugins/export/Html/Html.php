...
class JFormXPluginHtml extends JFormXPlugin{
	...
	function onExport( $pluginParameters,$requestParameters, $data ){
		...
		$html = file_get_contents(JPATH_COMPONENT_ADMINISTRATOR.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'export'.DIRECTORY_SEPARATOR.'Html'.DIRECTORY_SEPARATOR.'tmpl.html');
