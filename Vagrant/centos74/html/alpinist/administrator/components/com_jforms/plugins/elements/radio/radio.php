...
*
* @version		$Id: radio.php BsAlpinist 2.5.0 $
* @package		Joomla
...
//		$inputStyle = $p->useCss?'':"width:{$p->cw}px;height:{$p->ch}px;";
		...
		for($i=0;$i<count($elements);$i++){
			...
			if( $p->layout == 'List' ){
				$output .= _line('<div class="radio-vertical" style="display:block;" >',2);
			} else {
				$output .= _line('<div class="radio-horizontal" style="display:inline-block;" >',2);
			}
