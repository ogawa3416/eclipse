...
<tr>
	<td valign='top' width='300'>
		...
		<div class='tab-body' style='display:block' id='tab-filters'>
				...
				<h2><?php echo JText::_('DATABASE_FIELDS') ?></h2>
	...
	<td id='grid_container' valign='top'><div style='text-align:center;width:100%' id='loadingDiv'><?php echo JText::_('PROCESSINGPROCESSING'); ?><br /><div class='processing'>&nbsp;</div></div></td>
