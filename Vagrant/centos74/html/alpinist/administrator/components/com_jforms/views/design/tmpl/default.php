...
<div id='design-box'>
	<div id='side-bar'>
		...
		<div id='btn-form'    class='tab-button' onclick='javascript:enableTab("form");'><?php echo JText::_('FormForm')?></div>
		<div id='btn-element' class='tab-button' onclick='javascript:enableTab("element");'><?php echo JText::_('ElementElement')?></div>
		<br clear='all' />
		...
		<div class='tab-body' style='display:none' id='tab-form'>
			<div id='tab-form-container'>
				<form action="index.php" method="post" name="adminForm" id="adminForm">
					...
					<?php echo JHtml::_('sliders.start',"form-pane");?>
		...
		<div class='tab-body' style='display:none' id='tab-element'>
			<div id='tab-element-container'>
				<h3><?php echo JText::_('ELEMENT_PROPERTIES'); ?><div id="lock-toggle" class='unlocked' onclick="toggleElementPaneScroll(this)"></div></h3>
				<br clear='all' />
	...
	<div id='workarea-td'>
		<input onclick='alignLabels()' type='button' value='<?php echo JText::_('ALIGN_LABELS') ?>' style='float:left;margin-bottom:10px;font-size:12px' />
		<input onclick='alignControls()' type='button' value='<?php echo JText::_('ALIGN_CONTROLS') ?>' style='float:left;margin-bottom:10px;font-size:12px' />
		<input onclick='hideAllErrors()' type='button' value='<?php echo JText::_('HIDE_ERRORS') ?>' style='float:left;margin-bottom:10px;font-size:12px' />
		<br clear='all' />
...
<div id='jformver'><?php JHTML::_('JForms.General.version'); ?></div>