 ...
 * @license		GNU/GPL
 * @version		$Id: dedit.php 88 2012-01-24 08:51:40Z BsAlpinist ver.2.3.0 $
 **/
...
Joomla.submitbutton = function(pressbutton)
{
	...
	if( dr.length ) dr = "/"+dr;
	if( pressbutton == 'accontrol.divnew' ) {
        if (window.parent)
        {
            window.parent.updatedivFor(dk.value,dr);
			window.parent.SqueezeBox.close();
        }
		return false;
	}
...
<form action="index.php?option=com_bscore" method="post" name="adminForm" id="adminForm" >
    ...
    <legend>
		<?php echo JText::_( "BSC_DIV_ACCEDIT_INFO" );?>
    </legend>
	...
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				...
				<?php } elseif ($this->data->divpages == 'none') { ?>
		...
		<tr>
			<td valign="top" class="key">
				<?php echo JText::_( 'BSC_DIVISION_SELECTION' ); ?>:
			</td>
			<td>
				<?php  echo $this->accdivlist; ?>
			</td>	
		</tr>
	</table>
	...
	<input class="button" type="button" onclick="Joomla.submitbutton('accontrol.divnew')" value="<?php echo $this->data->divkey?JText::_('BSC_ENTRY_UPDATE'):JText::_('BSC_ENTRY_NEW') ?>" style="margin-left: 100px;width: 60px;">
