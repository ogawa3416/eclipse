...
// Alpinist for Edge(multi byte) 20161130
//			if (($this->client->engine == JApplicationWebClient::TRIDENT) && !StringHelper::is_ascii($url))
if (($this->client->engine == JApplicationWebClient::TRIDENT || strpos($this->client->userAgent,'Edge') !== false) && !StringHelper::is_ascii($url))
			{
				$html = '<html><head>';
