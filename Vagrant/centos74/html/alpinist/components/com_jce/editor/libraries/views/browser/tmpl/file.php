...
<!-- Add for BsAlpinist  20111215 Start /-->
	<?php $app = JFactory::getApplication();
		  $input = $app->input;
	?>
	<input type="hidden" name="jspjid" value="<?php echo $input->get('jspjid');?>" />
	<input type="hidden" name="jscatid" value="<?php echo $input->get('jscatid');?>" />
<!-- Add for BsAlpinist  20111215 End /-->
